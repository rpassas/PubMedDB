...
```
=======
>>>>>>> 1d9a6f06cdfe6fd3fe5c848f63ad133381f4c3ef
...
for (r in 1:numArticles) {
  a <- Journal.df$journal_id[which(Journal.df$journal_id == Article.df$journal_id[r])]
  Article.df$journal_id[r] <- a
}
```
